...
class ObjectLatencyAnalyzer(Analyzer):
    ...
    def replay_record(self, is_tcp, object_size):
        total_tx = 0
        total_grant = 0
        ...
        for time, event in enumerate(self.whole_record):
            ...
            ## BSR event
            if self.bsr_trig_record[time] == 1:    
            ...
            if (event_buffer < 500 or event_grant < 500) and object_state == object_tx:
                idle_stack += 1
                idle_time = 5
                if idle_stack >= idle_time:
                    ...
                    if object_tx_byte > object_size:
                        ...
                        print('End of object ', self.num_of_objects)
            else:
                idle_stack = 0
    ...
    def calc_delay (self, start_time = 100, fin_time = 100000, object_size = 80*1024):
        self.replay_record(False, object_size)
    ...
    def analyze_object_delay(self):
        ...
        try:
            ...
            print('Mean grant of Object : ', grant_mean, np.std(grant_arr))
            print('Initial grant of Object : ', initial_grant_mean)
            print('RB of Object : ',sched_grant_mean)
            print('=======================================')
        except:
            print('Error, check is the log about object transmission (not full buffer traffic)')
            
        return object_analysis, overall_mean, init_mean, sched_mean, tx_mean, grant_mean, init_arr, sched_arr, grant_arr, overall_arr, rb_arr, mcs_arr
