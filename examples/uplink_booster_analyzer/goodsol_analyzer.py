...
class MyAnalyzer(Analyzer):
    ...
    def callback_pusch_tx(self, msg):
        ...
        if 'Records' in log_item:
            for record in log_item['Records']:
                tb_dict = {}
                tb_dict['timestamp'] = timestamp
                tb_dict['fn and sfn'] = record['Current SFN SF']
                tb_dict['TB Size'] = record['PUSCH TB Size']
                self.log_info("TB granted "+ str(tb_dict))
    ...
    def callback_pucch(self, msg):
        ...
        for record in records:
            ...
            if uciformat == 'Format 1':
                ...
                #print('SR time: ', sr_dict['fn and subfn'])
    ...
    def callback_pusch(self, msg):
        ...
        self.log_debug('PUSCH_CQI: ' + str(bcast_dict))
